  ...
  if (isWrongNetwork) {
    return (
      <Button
        ...
        className="bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold rounded-full px-6 shadow-lg animate-pulse"
      >
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold rounded-full px-6 shadow-lg hover:shadow-xl transition-all">
          <motion.div
      ...
      <DropdownMenuContent align="end" className="w-72">
        ...
        {/* Balance */}
        <div className="px-2 py-3 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg mx-2 mb-2">
